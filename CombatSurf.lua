...
local Window = Rayfield:CreateWindow({
   Name = "zayne hub | Combat Surf",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "setting up ui...",
   LoadingSubtitle = "by kazumi",
...
local CredsTab = Window:CreateTab("Credits", 4483362458) -- Title, Image

local Button = MainTab:CreateButton({
   Name = "Discord Invite Link [soon]",
   Callback = function()
    -- skibdi
   end,
})
...
local Button = MainTab:CreateButton({
   Name = "Remove Textures [FPS Increase]",
   Callback = function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/musertzscripts/script/refs/heads/main/removetext.lua"))()
   end,
})
...
local Label = CredsTab:CreateLabel("UI made by: Sirius / Hub made by : kazumi/Musertz", 4483362458, Color3.fromRGB(255, 255, 255), false) -- Title, Icon, Color, IgnoreTheme
